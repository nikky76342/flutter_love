...
class PuzzleBloc extends Bloc<PuzzleEvent, PuzzleState> {
  ...
  final List<int> arabianRomanNumbers = [
    1000,
    900,
    500,
    400,
  ...
  final List<String> romanNumbers = [
    'M',
    'CM',
    'D',
    'CD',
  ...
  String intToRoman(int input) {
    ...
    for (var a = 0; a < arabianRomanNumbers.length; a++) {
      ...
      num -= times *
          arabianRomanNumbers[a]; // subtract prev roman number value from num
    }
